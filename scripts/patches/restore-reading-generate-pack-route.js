/**
 * Restore a known-good /api/reading/generate-pack route.tsx
 * Run from repo root: node scripts/patches/restore-reading-generate-pack-route.js
 */
const fs = require("fs");
...
console.log("👉 Now restart dev server: Ctrl+C then npm run dev");
